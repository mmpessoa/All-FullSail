...
//Load images
        ...
        $('<p>').html('Type of Being: ' + value[6]).appendTo('. cryptDiv');
        $('<p>').html('Encounter Description: ' + value[7]).appendTo('. cryptDiv');
        $('<p>').html('Subscribe to Newsletter? ' + value[8]).appendTo('. cryptDiv');
